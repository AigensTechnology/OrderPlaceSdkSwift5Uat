...
s.name = "OrderPlaceSdkSwift5Uat"
s.version = "0.1.4"
s.summary = "Order Place Sdk swift5 Uat"

s.description = <<-DESC
a pod that easily implements the order.place function
DESC

s.homepage = "https://github.com/AigensTechnology/OrderPlaceSdkSwift5Uat"
s.license = { :type => 'MIT', :file => 'LICENSE' }
s.author = { "风筝" => "13286953452@126.com" }

s.source = { :git => "https://github.com/AigensTechnology/OrderPlaceSdkSwift5Uat.git", :tag => "#{s.version}" }
...
ali.libraries = 'z', 'c++'
ali.dependency 'OrderPlaceSdkSwift5Uat/Core'
end
...
wechat.dependency 'OrderPlaceSdkSwift5Uat/Core'
end
...
sa.dependency 'OrderPlaceSdkSwift5Uat/Core'
end
