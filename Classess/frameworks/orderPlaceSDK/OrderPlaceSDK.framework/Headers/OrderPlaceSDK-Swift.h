...
SWIFT_PROTOCOL("_TtP13OrderPlaceSDK14AlipayDelegate_")
@protocol AlipayDelegate
- (void)AlipayOrderWithBody:(NSDictionary * _Nonnull)body callback:(CallbackHandler * _Nullable)callback;
- (void)AlipayGetVersionWithCallback:(CallbackHandler * _Nullable)callback;
- (void)AlipayApplicationOpenUrl:(UIApplication * _Nonnull)app url:(NSURL * _Nonnull)url;
- (BOOL)AlipayFetchOrderInfoWithUrl:(NSString * _Nonnull)url alipayScheme:(NSString * _Nonnull)alipayScheme SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, strong) WKWebView * _Nullable AliapyWebView;
@end

@class WKUserContentController;

SWIFT_CLASS("_TtC13OrderPlaceSDK15CallbackHandler")
@interface CallbackHandler : NSObject
@property (nonatomic, strong) WKUserContentController * _Null_unspecified cc;
@property (nonatomic, copy) NSString * _Null_unspecified callback;
@property (nonatomic, strong) WKWebView * _Null_unspecified webView;
- (void)successWithResponse:(id _Nonnull)response;
...
SWIFT_CLASS("_TtC13OrderPlaceSDK10GpsService")
@interface GpsService : OrderPlaceService <CLLocationManagerDelegate>
